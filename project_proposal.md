...
| | Description | Fill in |
| This will be a restaurant review application. A user can log in, find restaurants based on their search word, leave restaurant review and browse other users reviews---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Tech Stack | What tech stack will you use for your final project? It is recommended to use the following technologies in this project: Python/Flask, PostgreSQL, SQLAlchemy, Heroku, Jinja, RESTful APIs, JavaScript, HTML, CSS. Depending on your idea, you might end up using WTForms and other technologies discussed in the course. | Python/Flask, PostgreSQL, SQLAlchemy, RESTful APIs, JavaScript, HTML, CSS|
| Type | Will this be a website? A mobile app? Something |else? |This will be a web app|
| Goal | What goal will your project be designed to achieve? |The project will allow a user to see restaurant reviews before visiting and allow them to leave a review after visiting|
| Users | What kind of users will visit your app? In other words, what is the demographic of your users? |Users that are usually looking for reviews |
| Data | What data do you plan on using? How are you planning on collecting your data? You may have not picked your actual API yet, which is fine, just outline what kind of data you would like it to contain. You are welcome to create your own API and populate it with data. If you are using a Python/Flask stack, you are required to create your own API. |I will be retrieving restaurant information from an API and the rest of the app will be using my own endpoints |
